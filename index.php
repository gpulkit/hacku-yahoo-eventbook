...
function addMarker(loc, ev_name, lat, lon, pic_url, desc, start_time, end_time) 
{
	...
	var contentString = '<img src=\''+pic_url+'\'/><div style="font-size:8px; float:right;"><b>'+ev_name+'</b><br>'+desc+'<br>'+s_d.toDateString()+'  '+s_d.toTimeString()+'<br>'+e_d.toDateString()+'  '+e_d.toTimeString()+'</div>';
